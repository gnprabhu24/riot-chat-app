<signin-help-form>
    ...
    <div class="signin_help_form_outter_div" onkeypress={ keypressedEnter }>
      ...
      <div  class="form_row">
        <a class="a_btn" show = { btn_help && !selectionMade } onclick={ showVerificationLink }>Problems with Verification link</a>
        <a class="a_btn" show = { btn_help && !selectionMade } onclick={ showForgotPasswordLink }>Forgot Password</a>
      </div>
