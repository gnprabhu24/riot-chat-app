<login-form>
    ...
    <div class="login_form_outter_div" onkeypress={ keypressedEnter }>
      ...
      <div show={ err_auth } class="form_row">
		...
		<div class="form_row">
			<input class="form_row_input" type="password" placeholder="Enter your Password" ref="user_pass" autocomplete="off" value="" />
		</div>
		...
		<div show = { btn_login } class="form_row">
			Not a Registered User? <a class="a_href" onclick={ gotoSignUp }>Sign up</a>
		</div>

    <div show = { btn_login } class="form_row">
      <a class="a_href"  onclick={ gotoSignInHelp }>Need Help with Sign In?</a>
    </div>
    </div>
	</div>
