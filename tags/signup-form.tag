<signup-form>
    ...
    <div class="signup_form_outter_div" onkeypress={ keypressedEnter }>
      ...
      <div class="form_row">
        <input class="form_row_input" type="text" maxlength="23" placeholder="Enter a Username" ref="user_username"  autocomplete="off" value="" />
      </div>
    	<div class="form_row">
  			<input class="form_row_input" type="text" placeholder="Enter an Email Id" ref="user_email" autocomplete="off" value="" />
  		</div>
  		...
  		<div class="form_row">
  			<input class="form_row_input" type="password" placeholder="Enter a Password" ref="user_pass" autocomplete="off" value=""/>
  		</div>
  		<div show={ err_user_pass } class="form_row">
      		<span class="form_error">Please enter a password.</span>
  		</div>
      <div class="form_row">
        <input class="form_row_input" type="password" placeholder="Confirm the Password" ref="user_confirm_pass" oninput={ validatePasswordMatch } autocomplete="off" value=""/>
      </div>
      ...
      <div class="form_row">
           Already a member? <a class="a_href" onclick={ gotoLogin } >Login</a>
      </div>
      </div>
  	</div>
